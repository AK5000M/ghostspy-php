...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11/10/2024 às 17:47
...
--
-- Restrições para tabelas `aplicativos`
--
ALTER TABLE `aplicativos`
  ADD CONSTRAINT `aplicativos_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id`);
COMMIT;
